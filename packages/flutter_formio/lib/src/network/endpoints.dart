...
class ApiEndpoints {
  ...
  static String userExists(String email) =>
      '/user/exists?email=${Uri.encodeComponent(email)}';
  ...
  static String getAction(String formId, String actionId) =>
      '/form/$formId/action/$actionId';

  /// Returns the path to update an action
  /// Example: `/form/formId/action/actionId`
  static String updateAction(String formId, String actionId) =>
      '/form/$formId/action/$actionId';

  /// Returns the path to delete an action
  /// Example: `/form/formId/action/actionId`
  static String deleteAction(String formId, String actionId) =>
      '/form/$formId/action/$actionId';
