...
class FormioValidators {
  ...
  /// Helper to get the JavaScript evaluator instance.
  static JsEvaluator? _getJavaScriptEvaluator() {
    try {
      // Get the current JavaScript evaluator instance
      return JavaScriptEvaluator.instance;
    } catch (e) {
      return null;
    }
  }
