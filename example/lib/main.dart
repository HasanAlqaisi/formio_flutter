// Example entrypoint: renders a real Form.io form NATIVELY, with all logic
// (calculations, conditionals, Logic-tab, custom validation) driven by
...
class _FormPickerState extends State<FormPicker> {
  ...
  Future<void> _open() async {
    ...
    try {
      ...
      final tpl =
          outer is Map && outer['template'] != null ? outer['template'] : outer;
      final form =
          (tpl is String ? jsonDecode(tpl) : tpl) as Map<String, dynamic>;
      if (!mounted) return;
                ...
                body: EngineFormRenderer(
                  ...
                  onSubmit: (data) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('Valid — submitted (see console)'),
                      ),
                    );
                  },
                ),
